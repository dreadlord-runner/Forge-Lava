  ...
  return (
    <div>
      ...
      <div className="flex items-stretch bg-innerBorderGray">
        ...
        <div className="flex-1 px-6 md:px-10 lg:px-12 py-2 md:py-2.5 flex items-center space-x-3 font-mono text-xs border-r border-gray-100 mr-32">
        ...
        <div className="max-w-7xl mx-auto border-x border-gray-100 bg-white">
          ...
          <div className="flex py-16 md:py-20">
            ...
            <div className="-mx-4">
              <div className="max-w-4xl">
                ...
                <p className="text-[1.3rem] font-light text-gray-500 leading-tight max-w-2xl">
                  Simplify deployment and server management with tools that{" "}
                  <br className="hidden md:block" /> scale, without the DevOps
                  complexity.
                </p>
              </div>
            </div>
          ...
          <div className="w-full">
            <div className="grid grid-cols-1 lg:grid-cols-2 border-t border-gray-100 bg-white">
              {/*--------Card 1------ */}
              <div className="border-b px-25 pt-10 lg:border-r border-gray-100  flex flex-col bg-white">
                <h3 className="text-xl text-gray-900 mb-3">
                  Launch your app your way
                </h3>
                <p className="text-gray-500 mb-12 leading-relaxed">
                  Spin up a Laravel VPS with instant provisioning or <br />{" "}
                  connect to your favorite cloud provider in minutes.
                </p>
                    ...
                    <div className="border rounded-xl p-4 border-gray-200 bg-white">
                      <div className="grid grid-cols-3 gap-x-7 gap-y-2">
                        {providers.map((item, i) => (
                          <div
                            key={i}
                            className={`border-2 rounded-xl px-15 py-3 flex flex-col items-center justify-center transition-all duration-200 hover:bg-gray-100 ${item.active ? "border-[#5AB5A5] shadow-[0_0_7px_rgba(1,138,114,0.6)]" : "border-gray-200"} ${item.disabled ? "opacity-40" : "cursor-pointer"}`}
                          >
                            {/*--------ICONS---------- */}
                            ...
                            <p className="whitespace-nowrap mt-2 text-sm font-medium text-gray-700">
                              {item.name}
                            </p>
                          </div>
                        ))}
              ...
              {/*-----------Card 2---------- */}
              <div className="px-25 pt-10 border-b border-gray-100 flex flex-col bg-white">
                <h3 className="text-xl text-gray-900 mb-3">
                  A full server stack, ready in minutes{" "}
                </h3>
                <p className="text-gray-500 mb-12  leading-relaxed">
                  Forge installs Nginx, PHP, MySQL, Postgres, Redis, <br /> and
                  all the essentials on your cloud of choice.
                </p>
                    ...
                    <div className="relative border rounded-xl border-gray-200 bg-white p-6 md:p-8">
                      ...
                      <div className="relative space-y-8 pr-6">
                        ...
                        <div className="flex items-center space-x-6">
                          ...
                          <span className="text-gray-900">Installing PHP</span>
                        </div>
              ...
              {/* --------Card 3--------- */}
              <div className="px-25 pt-10 border-b lg:border-r border-gray-100 flex flex-col bg-white">
                <h3 className="text-xl text-gray-900 mb-3">
                ...
                <div className="relative overflow-hidden">
                  <div className="border rounded-xl p-2 border-gray-200 bg-innerBorderGray">
                    <div className="relative rounded-tl-2xl border-t border-l p-2 border-gray-200 bg-white">
                      <div className="h-full overflow-hidden pr-12 w-[150%] sm:w-full pt-4 pl-4">
